...
int LOCATION_ID = 1070; // Put here your location id
int SUBLOCATION_ID = 1422; // Put here your sublocation id
                  ...
                  child: LocationView(
                    onMapCreated:
                      ...
                      if (await bluetoothscanPermissionNotGranted) {
                        _showMessage(context,
                            Text('Bluetooth scan permission was NOT granted'));
                      }

                      if (await bluetoothPermissionNotGranted) {
                        _showMessage(context,
                            Text('Bluetooth permission was NOT granted'));
                      }
